...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_profile') {
    ...
    if (empty($name)) {
        ...
        if ($stmt->execute([$name, $phone, $user['id']])) {
            ...
            log_activity($user['id'], 'profile_updated', 'User updated profile information');
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 0.5rem;">
                                                <a href="booking-detail.php?id=<?php echo $booking['id']; ?>" 
                                                   class="btn" style="padding: 0.25rem 0.5rem; font-size: 0.8rem; background: var(--primary-color); color: white; text-decoration: none; border-radius: 4px;">
